...
absl::Status AppendCounterData(
  ...
  if (auto packets_iter = counter_data.find("packets");
    ...
    table_entry.mutable_counter_data()->set_packet_count(0); //because counter function not implemented yet.
  }
  ...
  if (auto bytes_iter = counter_data.find("bytes");
    ...
    table_entry.mutable_counter_data()->set_byte_count(0); // because counter function not implemented yet.
  }
