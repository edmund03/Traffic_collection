    ...
    : Orch(db, tableNames)
{
    ...
    m_udfTableManager = std::make_unique<p4orch::UdfTableManager>(&m_p4OidMapper, vrfOrch, coppOrch, &m_publisher);
    ...
    m_p4TableToManagerMap[APP_P4RT_UDF_PORTCLASSIFICATION_NAME] = m_udfTableManager.get();
    m_p4TableToManagerMap[APP_P4RT_UDF_PAYLOADCLASSIFICATION_NAME] = m_udfTableManager.get();
    ...
    m_p4ManagerPrecedence.push_back(m_udfTableManager.get());
