...
// /*added by hs*/
// #define UDF_TABLE_NUM 10

// enum UdfTableType
// {
//     UdfPortCollection = 0,
//     UdfPayloadCollection = 1,
// };
//end

#define SAI_OBJECT_TYPE_UDF_TABLE_ENTRY 102
extern "C"
{
#include "sai.h"
}
...
class P4OidMapper
{
  ...
  private:
    ...
    std::unordered_map<std::string, MapperEntry> m_oidTables[SAI_OBJECT_TYPE_MAX+1];
    // std::unordered_map<std::string, UdfEntry> m_uidTables[UDF_TABLE_NUM];
