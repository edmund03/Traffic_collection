...
const bit<32> MPLS_FIB_TABLE_SIZE = TUNNEL_NEXTHOP_TABLE_SIZE;
const bit<32> SRV6_NEXTHOP_TABLE_SIZE = 4096;
const bit<32> MY_SID_TABLE_SIZE = 512;
...
@pa_no_overlay("ingress", "local_md.tunnel.remove_srh")
