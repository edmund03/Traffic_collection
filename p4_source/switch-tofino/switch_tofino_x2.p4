...
control SwitchIngress(
    ...
    apply {
        ...
        if(local_md.flags.acl_deny == false && local_md.ingress_port != 0x104 && local_md.ingress_port != 0x1A0){
            ingress_ip_mirror_acl.apply(local_md, local_md.unused_nexthop, hdr);
        }
/*
...
*/
        ...
        if (local_md.flags.rmac_hit) {
            ...
            if (local_md.ingress_port == 0x188 || local_md.ingress_port == 0x190){
                local_md.egress_port_lag_index = 0X3E;
            } else {
